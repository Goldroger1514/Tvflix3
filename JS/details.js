...
function pageSections(){
  let pageSections=document.querySelector('.page-sections');
    ...
    `;
    fetchDataFromServer(`https://api.themoviedb.org/3/movie/${localStorage.getItem('movieId')}/recommendations?api_key=489f7b75005de75c58b6cc0f3f9608e2&language=en-US&page=1`,
