...
function pageSections(){
  ...
  currentPage=localStorage.getItem('currentPage');
    fetchDataFromServer(`https://api.themoviedb.org/3/discover/movie?api_key=489f7b75005de75c58b6cc0f3f9608e2&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${currentPage}&${localStorage.getItem('urlParam')}`,
